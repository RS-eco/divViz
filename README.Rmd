---
title: "divViz: Visualisierungs-Tool für Biodiversitäts-Daten"
...
You are visiting the github repository of the divViz (Visualisierungs-Tool für Biodiversitäts-Daten) package. divViz is a shiny based [web app](https://rs-eco.shinyapps.io/divViz_de/) supporting interactive exploratory data analysis of simulated biodiversity data.
...
knitr::include_graphics("figures/divViz_de.png")
```

If you are interested to see what divViz has to offer without diving into R, click [here](https://rs-eco.shinyapps.io/divViz_de/).
